...
/// A view for displaying a rating
@available(macOS 11.0, *)
public struct RatingIndicator: NSViewRepresentable {
	var value: Double
	var title: String
	...
	/// Creates a new RatingIndicator
	/// - Parameters:
	///   - title: The string to use as the RatingIndicator's accessibility label
	///   - value: The rating value to display
	///   - min: The minimum rating allowed
	///   - max: The maximum rating allowed
	///   - image: The image to use as the fill image for the indicator. If this doesn't exist in your asset catalog or is an invalid SF Symbol, your app will crash.
	///   - placeholderImage: The image to use as the placeholder image for the indicator. If this doesn't exist in your asset catalog or is an invalid SF Symbol, your app will crash.
	public init(_ title: String, value: Double, min: Double = 0, max: Double = 5, image: RatingImage, placeholderImage: RatingImage) {
		self.title = title
		self.value = value
		self.minValue = min
		self.maxValue = max
