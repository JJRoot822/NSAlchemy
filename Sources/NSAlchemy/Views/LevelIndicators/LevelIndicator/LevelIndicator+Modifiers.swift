...
extension LevelIndicator {
    ...
    public func indicatorFill(color: Color) -> LevelIndicator {
        var indicator = self
    ...
    /// - Returns: The modified LevelIndicator``
    public func indicatorWarning(value: Double, color: Color) -> LevelIndicator {
        var indicator = self
    ...
    /// - Returns: The modified LevelIndicator
    public func indicatorWarning(fraction: Double, color: Color) -> LevelIndicator {
        var indicator = self
    ...
    /// - Returns: THe modified LevelIndicator
    public func indicatorCritical(value: Double, color: Color) -> LevelIndicator {
        var indicator = self
    ...
    /// - Returns: The modified LevelIndicator
    public func indicatorCritical(fraction: Double, color: Color) -> LevelIndicator {
        var indicator = self
    ...
    public func tierdCapacityLevels() -> LevelIndicator {
        var indicator = self
