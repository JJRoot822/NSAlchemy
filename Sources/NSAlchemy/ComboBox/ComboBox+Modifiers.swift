...
extension ComboBox {
    ...
    func itemHeight(_ height: CGFloat) -> ComboBox {
        var comboBox = self
    ...
    /// - Returns: The modified ComboBox
    func itemSpacing(horizontalSpacing: CGFloat, verticalSpacing: CGFloat) -> ComboBox {
        var comboBox = self
    ...
    /// - Returns: The modified ComboBox.
    func visibleItems(_ count: Int) -> ComboBox {
        var comboBox = self
